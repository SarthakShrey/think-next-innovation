  ...
  return (
    <>
      <section id="contact" className=" pt-12 md:py-0 px-4 lg:px-[120px]">
        <div className="clip">
          <h3 className="contactHeading text-primary text-6xl font-bold mb-4">
            Contact us
          </h3>
        </div>
        <div className="clip">
          <h2 className="contactTag pb-8 text-4xl font-medium">
            {" "}
            Connect with Next Innovation
          </h2>
        </div>
